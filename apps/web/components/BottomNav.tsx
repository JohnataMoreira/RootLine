        ...
        <>
            ...
            <nav className="fixed bottom-0 left-0 right-0 bg-bg/90 backdrop-blur-md border-t border-border px-6 py-3 pb-6 z-50">
                <div className="flex justify-between items-center max-w-md mx-auto">
                    <Link href="/timeline" className={`flex flex-col items-center gap-1 transition-transform active:scale-[0.90] ${isActive('/timeline') ? 'text-primary' : 'text-slate-400'}`}>
                    ...
                    <Link href="/tree" className={`flex flex-col items-center gap-1 transition-transform active:scale-[0.90] ${isActive('/tree') ? 'text-primary' : 'text-slate-400'}`}>
                    ...
                    <Link href="/profile" className={`flex flex-col items-center gap-1 transition-transform active:scale-[0.90] ${isActive('/profile') ? 'text-primary' : 'text-slate-400'}`}>
